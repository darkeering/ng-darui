...
export class DownOutlined { }

@Directive({
  selector: '[darDownOutlined]'
})
export class DownOutlinedDirective {
  constructor(
    ...
    const component = this.componentFactoryResolver.resolveComponentFactory(DownOutlined)
