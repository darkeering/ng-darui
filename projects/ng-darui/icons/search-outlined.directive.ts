...
export class SearchOutlined { }

@Directive({
  selector: '[darSearchOutlined]'
})
export class SearchOutlinedDirective {
  constructor(
    ...
    const component = this.componentFactoryResolver.resolveComponentFactory(SearchOutlined)
